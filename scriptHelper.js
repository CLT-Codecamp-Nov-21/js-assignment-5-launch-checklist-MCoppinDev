...
function formSubmission(document, list, pilot, copilot, fuelLevel, cargoLevel) {
  ...
  } else if ( validateInput(pilot) === "Number" || validateInput(copilot) === "Number" || validateInput(fuelLevel) === "Not a Number" || validateInput(cargoLevel) === "Not a Number") {
    alert("valid information needed for each field.");
